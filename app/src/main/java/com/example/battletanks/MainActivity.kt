...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.editorEnemyRespawn.setOnClickListener { elementDrawer.currentMaterial = Material.ENEMY_TANK_RESPAWN }
        binding.editorPlayerRespawn.setOnClickListener { elementDrawer.currentMaterial = Material.PLAYER_TANK_RESPAWN }
    ...
    private fun showSettings ()
    {
        ...
        elementDrawer.changeElementsVisibility(true)
    }
    ...
    private fun hideSettings()
    {
        ...
        elementDrawer.changeElementsVisibility(false)
    }
